...
public class Cycle implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getWeekSeq() == null ? other.getWeekSeq() == null : this.getWeekSeq().equals(other.getWeekSeq()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getWeekSeq() == null) ? 0 : getWeekSeq().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", weekSeq=").append(weekSeq);
